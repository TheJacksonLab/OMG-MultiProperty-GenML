...
class MPNEncoder(nn.Module):
    ...
    def __init__(self, atom_fdim, bond_fdim, hidden_size: int = None, bias: bool = True, depth: int = None,
                 device: torch.device = 'cpu', dropout_rate: float = 0.0):
        """
        ...
        :param dropout_rate: rate for drop out
       """
        # inputs
...
class MPN(nn.Module):
    ...
    def __init__(self,
        ...
        self.atom_fdim = get_atom_fdim(overwrite_default_atom=False, is_reaction=False)
        self.bond_fdim = get_bond_fdim(overwrite_default_atom=False, overwrite_default_bond=False,
                                       atom_messages=False, is_reaction=False)
        self.features_only = False
        self.use_input_features = False
        self.atom_descriptors = None
        self.bond_descriptors = None
