...
class TransformerDecoderLayer(TransformerDecoderLayerBase):
    ...
    def _forward(
        ...
        assert not self.parallel_residual
        if self.parallel_residual:  # not used - False
            # need to modify the enc_out
...
# from onmt/decoders/transformer.py
class TransformerDecoder(TransformerDecoderBase):
    ...
    def forward(self, tgt, enc_out=None, step=None, **kwargs):
        ...
        # Customized GV - to get embeddings with added latent vectors.
        ...
        src_pad_mask = sequence_mask(src_len, src_max_len).unsqueeze(1)  # [B x 1 x slen]. Previous: ~sequence_mask. But the definition (miscs/sequence_mask) has been changed.
