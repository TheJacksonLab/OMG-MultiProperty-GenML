...
from utils.functions import terminate_p_smi_with_CH3

if __name__ == '__main__':
    """
    This script analyzes Bayesian optimization over a hypercube.         
    """
    ####### MODIFY #######
    # load vae parameters
    ...
    # hypercube_length_list = [0.1, 0.2]  # scaled

    # TODO - save from the bo script - reference polymer
    reference_polymer = '*OCCN(CCOC(=O)C(CCCc1ccsc1)C(*)=O)c1ccccn1'
    reference_polymer_property = np.array([-0.3432252, 2.9389224, 1.3219053])  # linear
    # reference_polymer_property = np.array([-0.31731322, 2.8342094, 1.2792248])  # non-linear
    ####### MODIFY #######
